            ...
            {steps.map((s, i) => (
              ...
              >
                ...
                <div>
                  ...
                  <h3
                    className={`font-display text-xl mb-2 ${i === steps.length - 1 ? "text-coral" : "text-foreground"
                      }`}
                  >
                    {s.label}
                  </h3>
            ...
            {steps.map((s, i) => (
              ...
              >
                ...
                <div className="pt-1">
                  ...
                  <h3
                    className={`font-display text-xl mb-1 ${i === steps.length - 1 ? "text-coral" : "text-foreground"
                      }`}
                  >
                    {s.label}
                  </h3>
